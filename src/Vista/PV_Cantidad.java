...
public class PV_Cantidad extends javax.swing.JFrame {
     ...
     */
    public PV_Cantidad() {
        initComponents();  // Este initComponents es el generado y ya crea todos los componentes
    ...
    private void initComponents() {
        ...
        jSpinner1.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        ...
        jSpinner2.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        jSpinner2.setModel(new javax.swing.SpinnerNumberModel(0, 0, 300, 1));

        jLabel3.setFont(new java.awt.Font("Nimbus Sans", 0, 12)); // NOI18N
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/imagenpelicula.jpg"))); // NOI18N
    ...
    try {
        new Asientos(boletosNuevos).setVisible(true); // Aquí pasamos el parámetro
