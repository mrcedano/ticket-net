...
public class Historial extends javax.swing.JFrame {
    ...
    public Historial() throws Exception {
        ...
        historyContainer.setBackground(new Color(240, 240, 240));
        ...
        Map<String, Object>[] boletos = boletoModel.getBoletosCompradosByUserId(Global.user.getId());
        ...
        for (Map<String, Object> boleto : boletos) {
            addHistoryItem(historyContainer,
                    ...
                    (int) boleto.get("cantNinos"),
                    (int) boleto.get("total"),
                    (String) boleto.get("logo"));
        }
    }
    ...
    private void addHistoryItem(JPanel container, int funcionId, String movieTitle, int adults, int children,
        ...
        itemPanel.setComponentZOrder(printButton, 0);
