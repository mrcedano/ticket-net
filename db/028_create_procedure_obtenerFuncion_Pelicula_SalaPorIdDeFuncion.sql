...
BEGIN
 SELECT 
 	funciones.id, funciones.activadesde, funciones.activahasta, peliculas.id AS pelicula_id, peliculas.nombre AS 
        pelicula_nombre, peliculas.logo_filepath AS pelicula_logo, salas.id AS 
         sala_id , salas.nombre AS sala_nombre, 
